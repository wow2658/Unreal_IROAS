...
void ABossSlash::BeginPlay()
{
	...
	{
		attackDamage = rageTriggerBox->slashDamage;
		speed = rageTriggerBox->slashSpeed;
	}
}
...
void ABossSlash::OnComponentBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
