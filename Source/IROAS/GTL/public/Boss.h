...
public:
	...
	// 체력
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = BossInfo)
	float hp = 500.f;
...
public:
	...
	// 블링크 중 리본
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = BossFuntions)
	UNiagaraComponent* NiagaraRibbonComponent01;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = BossFuntions)
	UNiagaraComponent* NiagaraRibbonComponent02;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = BossFuntions)
	UNiagaraComponent* NiagaraRibbonComponent03;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = BossFuntions)
	UNiagaraComponent* NiagaraRibbonComponent04;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = BossFuntions)
	UNiagaraComponent* NiagaraRibbonComponent05;
...
public: // 피격 아웃라인 // 이제 안쓰이는 함수들
    ...
    USpringArmComponent* BossSpringArm1;

    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Camera)
    USpringArmComponent* BossSpringArm2;


    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Camera)
    UCameraComponent* BossCamera1;

    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Camera)
    UCameraComponent* BossCamera2;

	bool bIsCameraBlending = false;
	float CameraBlendAlpha = 0.0f;
	float CameraBlendDuration = 1.f;
	float ReturncameraDelay = 0;
